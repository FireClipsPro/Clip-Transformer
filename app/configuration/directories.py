...
CUTE_MUSIC_FOLDER = f'{pod_clips_root}songs/cute/'
FUNNY_MUSIC_FOLDER = f'{pod_clips_root}songs/funny/'
MOTIVATIONAL_MUSIC_FOLDER = f'{pod_clips_root}songs/motivational/'
INTRIGUING_MUSIC_FOLDER = f'{pod_clips_root}songs/fascinating/'
CONSPIRACY_MUSIC_FOLDER = f'{pod_clips_root}songs/conspiracy/'
HOPEFUL_MUSIC_FOLDER = f'{pod_clips_root}songs/hopeful/'
SCARY_MUSIC_FOLDER = f'{pod_clips_root}songs/scary/'
SERIOUS_MUSIC_FOLDER = f'{pod_clips_root}songs/serious/'
RAW_VIDEO_FOLDER = f"{pod_clips_root}full_pod_folder/"
INPUT_FOLDER = f"{pod_clips_root}InputVideos/"
AUDIO_EXTRACTIONS_FOLDER = f"{pod_clips_root}audio_extractions/"
IMAGE_FOLDER = f"{pod_clips_root}images/"
IMAGE_2_VIDEOS_FOLDER = f"{pod_clips_root}videos_made_from_images/"
OUTPUT_FOLDER = f"{pod_clips_root}OutputVideos/"
ORIGINAL_INPUT_FOLDER = f"{pod_clips_root}InputVideos/"
CHROME_DRIVER_PATH = f"{pod_clips_root}content_generator/chromedriver.exe"
RESIZED_FOLDER = f"{pod_clips_root}resized_original_videos/"
VIDEOS_WITH_OVERLAYED_MEDIA_PATH = f"{pod_clips_root}media_added_videos/"
QUERY_FOLDER = f'{pod_clips_root}queries/'
INPUT_INFO_FILE = f'{pod_clips_root}input_info.csv'
VIDEO_INFO_FOLDER = f"{pod_clips_root}video_info/"
GENERATED_PROMPTS_FOLDER = f"{pod_clips_root}generated_prompts/"
FINISHED_VIDEOS_FOLDER = f"{pod_clips_root}finished_videos/"
WITH_SUBTITLES_FOLDER = f"{pod_clips_root}subtitled_videos/"
PHOTO_AD_FOLDER = f"{pod_clips_root}photo_ads/"
BANNER_FOLDER = f"{pod_clips_root}banner_ads/"
VIDEOS_WITH_BANNER_FOLDER = f"{pod_clips_root}banner_videos/"
BACKGROUNDLESS_VIDEOS_FOLDER = f"{pod_clips_root}background_removed_videos/"
BACKGROUND_IMAGE_FOLDER = f"{pod_clips_root}background_images/"
IMAGE_SOUNDS_FOLDER = f"{pod_clips_root}image_display_sounds/"
DOWNLOADED_VIDEOS_FILE = f"{pod_clips_root}downloaded_videos/videos.csv"
BACKGROUND_FOLDER = f"{pod_clips_root}audio_only_backgrounds/"
FINISHED_AUD2VID_FOLDER = f"{pod_clips_root}finished_aud2vid/"
INTRO_VIDEOS = f"{pod_clips_root}intro_videos/"
...
VMS_MEDIA_ADDED_VIDEOS = f"{video_maker_root}media_added_videos/"
VM_WATERMARKS = f"{video_maker_root}watermarks/"
VM_WATERMARKED_VIDEOS = f"{video_maker_root}watermarked_videos/"
VM_SUBTITLED_VIDEOS = f"{video_maker_root}subtitled_videos/"
VM_TRANSCRIPTS = f"{video_maker_root}transcripts/"
VM_SCRIPTS = f"{video_maker_root}scripts/"
VM_VIDEOS_MADE_FROM_IMAGES = f"{video_maker_root}videos_made_from_images/"
VM_IMAGES = f"{video_maker_root}images/"
VM_AUDIO_INPUT = f"{video_maker_root}audio_input/"
VM_BLANK_VIDEOS = f"{video_maker_root}blank_videos/"
VM_AUDIO_EXTRACTIONS = f"{video_maker_root}audio_extractions/"
